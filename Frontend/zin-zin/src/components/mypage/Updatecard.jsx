...
const Updatecard = () => {
    ...
    const tagOptions = [
        ...
        "의지가 강한", "아이디어가 많은", "꼼꼼한", "변덕스러운", "열정적인", "전략적인", "대인관계가 원만한", "변화를 즐기는", "모임을 즐기는", "유연한", "독창적인", "신뢰할수있는", "체계적인", "설득력 있는", "느긋한", "겸손한", "동정심이 많은", "호기심 많은", "생기발랄한",
        "미래지향적인", "활동적인", "완벽을 추구하는", "계획적인", "집중력 있는", "대인관계가 넓은", "신중한", "적응력이 뛰어난", "수용적인", "끈기있는",
        "소신있는", "지도력 있는", "지혜로운", "결단력 있는", "충동적인", "혁신적인", "엄격한", "현재에 충실한", "단호한",
